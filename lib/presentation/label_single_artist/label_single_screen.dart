...
class LabelSingleScreen extends StatelessWidget {
  final String id;
  final String name;
  LabelSingleScreen(this.id, this.name);

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(LabelSingleArtistController());
    controller.setArtistId(id);
    ...
    return Scaffold(
      ...
      body: GetBuilder<LabelSingleArtistController>(
        builder: (_) {
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                Text(
                                  controller.artistStaticsModel.bank != 0.0 &&
                              ...
                              child: CupertinoSegmentedControl(
                                  ...
                                  onValueChanged: (value) {
                                    if (value == 0) {
                                      ...
                                      controller.getSingleArtistdata(
                                          id: id, days: '7');
                                      controller.update();
                                    } else if (value == 1) {
