                            ...
                            children: [
                                                    ...
                                                    : index == 2
                                                        ...
                                                        : index == 3
                                                            ...
                                                            : index == 4
                                                                ...
                                                                : index == 5
                                                                    ? controller.artistData.total_income !=
                                                                                0.0 &&
                                                                            controller.artistData.total_income <=
                                                                                0.5
                                                                        ? '<1\$'
                              ...
                              ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  if (index < controller.artistTracks.length) {
                                    final track =
                                    ...
                                    return GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          children: [
                                            CircleAvatar(
                                              backgroundColor: Color(0xff3B4E5F)
                                                  .withOpacity(0.04),
                                              radius:
                                                  ScreenHelper().setRadius(35),
                                              backgroundImage:
                                      ...
                                      controller.lastPage.value <
                                          controller.currentTrackPage.value) {
                                    return Center(
                                      child: CircularProgressIndicator(),
                                    );
                                  } else {
