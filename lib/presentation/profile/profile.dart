                ...
                return SafeArea(
                  child: RefreshIndicator(
                    ...
                    child: SingleChildScrollView(
                      padding:
                          EdgeInsets.only(bottom: ScreenHelper().setheight(20)),
                      child: Column(
                        children: [
                          Stack(
                                ...
                                children: [
                                  GestureDetector(
                                    ...
                                    child: CachedNetworkImage(
                                      ...
                                      height: ScreenHelper().setheight(160),
                                      fit: BoxFit.cover,
                                      errorWidget: (context, url, error) {
                                        return Column(
                                          children: [
                                            ...
                                            SvgPicture.asset(
                                                'assets/LogIn/dangify-artists.svg'),
                                            Text('Upload your Cover Photo'),
                                          ],
                                        );
                                      },
                                      imageUrl: EndPoint.base +
                                          controller.userdataModel.cover_url
                                              .toString(),
                                    ),
                                  ),
                                  Padding(
                                    padding: EdgeInsets.only(
                                        left: ScreenHelper().setWidth(300)),
                                    child: TextButton(
                                        style: ButtonStyle(),
                                        onPressed: () {
                                          Navigator.of(
                                      ...
                                      children: [
                                        GestureDetector(
                                          ...
                                          child: CachedNetworkImage(
                                            imageUrl: EndPoint.base +
                                                controller
                                                    .userdataModel.picture_url
                                                    .toString(),
                                            imageBuilder:
                                                (context, imageProvider) =>
                                                    CircleAvatar(
                                              radius:
                                                  ScreenHelper().setRadius(80),
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Text(controller.profileModel.total_income !=
                                              0.0 &&
                                          controller
                                                  .profileModel.total_income! <=
                                              0.5
                                      ? '<1\$'
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(controller.profileModel.bank != 0.0 &&
                                          controller.profileModel.bank! <= 0.5
                                      ? '<1\$'
                              ...
                              Padding(
                                padding: EdgeInsets.symmetric(
                                    horizontal: ScreenHelper().setWidth(15)),
                          ...
                          controller.bio != ''
                              ? Padding(
                                  padding: EdgeInsets.symmetric(
                                    horizontal: ScreenHelper().setRadius(10),
                                  ),
                                  child: Column(
                                    children: [
                                      Text(
                                        ...
                                        softWrap: true,
                                        maxLines:
                                            controller.descriptionMaxLines,
                                        overflow: TextOverflow.fade,
                                        style: TextStyle(
                                          color: Color(0xff3B4E5F),
                                        ),
                                      ),
                                      controller.bio.characters.length >= 1000
                                          ? SizedBox()
                                          : SizedBox(
                                              width: ScreenHelper.deWidth,
                                              child: TextButton(
                          ...
                          Row(
                            children: [
                              ...
                              SvgPicture.asset('assets/Artist/instagram.svg'),
                              SizedBox(
                                width: ScreenHelper().setWidth(5),
                              ),
                          ...
                          Row(
                            children: [
                              ...
                              SvgPicture.asset('assets/Artist/youtube.svg'),
                              SizedBox(
                                width: ScreenHelper().setWidth(5),
                              ),
                              controller.youtube == ''
                          ...
                          Row(
                            children: [
                              ...
                              SvgPicture.asset('assets/Artist/facebook.svg'),
                              SizedBox(
                                width: ScreenHelper().setWidth(5),
                              ),
                              controller.facebook == ''
