                          ...
                          ? Column(
                              children: [
                                ...
                                controller.isSingle.value
                                    ? controller.globeController.loginType
                                                .value ==
                                            1
                                        ? Column(
                                            children: [
                                              ...
                                              controller.featedArtists.value ==
                                                      0
                                                  ? SizedBox()
                                                  : Column(
                                                      children: [
                                                                        ...
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              controller: controller.featController2,
                                                                              style: TextStyle(color: Color(0xff3B4E5F)),
                                                                        ...
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                TextFormField(
                                                                              focusNode: FocusNode(canRequestFocus: false),
                                                                              controller: controller.featController3,
                                                                              style: TextStyle(color: Color(0xff3B4E5F)),
                                                                              decoration: InputDecoration(
                                                                                hintText: 'Featured artist name',
                                                                                border: InputBorder.none,
